...
* [research_file.md](research_file.md) — research questions, initial research goal, principles, findings, implications, sources, and supported versus uncertain assumptions.
